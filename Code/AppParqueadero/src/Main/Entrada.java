        ...
        if (!placa.isEmpty() &&  !selectVehiculo.getSelectedItem().equals("Seleccionar Vehiculo") && !encargado.isEmpty() ) {
            ...
            if (status) {
                ...
                if (success) {
                    ...
                    String insertTicket = consumo.consumoPOST("http://localhost:8080/insertarTicket", ticket);
                ...
                String insetRegistrov = consumo.consumoPOST("http://localhost:8080/insertarRegistro", insertRegistroV);
