...
public class CreateSeller extends javax.swing.JFrame {
    ...
    private void selectParkings(){
        ...
        if (selected != null) {
            ...
            // Agrega los parqueaderos a selectParking
    ...
    private void btnCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearActionPerformed
        ...
        if (!cedula.isEmpty() && !nombre.isEmpty() && !telefono.isEmpty() && !parqueadero.isEmpty() && !email.isEmpty() && !contrasenia.isEmpty()) {
            ...
            if(statusQuery){
                ...
                insertPersona.put("nombres", nombre);
                insertPersona.put("apellidos", apellido);
                insertPersona.put("telefono", telefono);
